...
A menudo, necesitamos crear correlaciones entre múltiples campos. Arrastrar los campos requeridos en el medio va a crear una pestaña de correlación en la pestaña de visualización. Aquí, seleccionamos `Source_Country` como segundo campo para mostrar la correlación entre el cliente `Source_IP`.

![[Pasted image 20260427225045.png]]

También podemos crear una tabla para mostrar los valores de los campos seleccionados como columnas:

![[Pasted image 20260427225103.png]]

El paso más importante de crear estas visualizaciones es guardarlas. Para ello, cliqueamos en la opción save en el lado derecho y llevamos los valores descriptivos:

![[Pasted image 20260427225145.png]]


## Creating Dashboards

Los dashboards proporcionan buena visibilidad en la colección de registros. Un usuario puede crear múltiples dashboards para completar las necesidades específicas. 

![[05016a6cc1c12d40b90ce9d290525378.gif]]
