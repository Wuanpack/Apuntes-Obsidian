...
Entre los datos que los ciberdelincuentes pueden obtener al buscar en ella están:
...
En ciberseguridad se considera un ataque de "baja tecnología", pero muy efectivo para obtener información de perfilado o acceso a sistemas, ya que la basura suele considerarse segura.

La mejor defensa es la destrucción física de documentos (usar destructoras de papel) y borrar de manera segura los dispositivos electrónicos antes de tirarlos.